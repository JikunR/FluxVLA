...
from fluxvla.models.third_party_models.cosmos3.model.attention.utils import is_torch_compiling
...
def generate_multi_dim_varlen_parameters(
    ...
    **Requires NATTEN >= 0.21.9.dev0**
    ...
    from fluxvla.models.third_party_models.cosmos3.model.attention.natten import NATTEN_VARLEN_MULTI_DIM_VERSION, natten_supported, natten_version_satisfies
