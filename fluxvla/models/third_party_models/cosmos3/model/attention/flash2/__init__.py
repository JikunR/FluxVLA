...
if FLASH2_SUPPORTED:
    from fluxvla.models.third_party_models.cosmos3.model.attention.flash2.functions import flash2_attention

else:
    from fluxvla.models.third_party_models.cosmos3.model.attention.flash2.stubs import flash2_attention
