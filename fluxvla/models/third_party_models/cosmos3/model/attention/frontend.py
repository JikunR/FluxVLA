...
from fluxvla.models.third_party_models.cosmos3.model.attention.backends import choose_backend, choose_multi_dim_backend
from fluxvla.models.third_party_models.cosmos3.model.attention.checks import (
...
from fluxvla.models.third_party_models.cosmos3.model.attention.flash2 import flash2_attention
from fluxvla.models.third_party_models.cosmos3.model.attention.flash3 import flash3_attention
from fluxvla.models.third_party_models.cosmos3.model.attention.masks import CausalType
from fluxvla.models.third_party_models.cosmos3.model.attention.natten import natten_attention, natten_multi_dim_attention
from fluxvla.models.third_party_models.cosmos3.model.attention.utils.environment import filter_attention_merge_backends
from fluxvla.models.third_party_models.cosmos3.model.attention.utils.safe_ops import log
...
def attention(
    ...
    dimension. Sequence lengths for different batches can be provided in two ways:
        ...
        2. `cumulative_seqlen_{Q,KV}` and `max_seqlen_{Q,KV}` (more efficient):
            ...
            parameters:
                ```python3
                from fluxvla.models.third_party_models.cosmos3.model.attention.varlen import generate_varlen_parameters
                (
                    cumulative_seqlen_Q,
...
def multi_dimensional_attention_varlen(
    ...
    **Requires NATTEN >= 0.21.9.dev0 and either Hopper or Blackwell DC-class architecture**
    ...
    from fluxvla.models.third_party_models.cosmos3.model.attention.natten import natten_supported
    ...
    from fluxvla.models.third_party_models.cosmos3.model.attention.natten.functions import natten_multi_dim_attention_varlen
