...
from fluxvla.models.third_party_models.cosmos3.model.attention.utils.version import version_at_least
...
if FLASH3_SUPPORTED:
    from fluxvla.models.third_party_models.cosmos3.model.attention.flash3.functions import flash3_attention

else:
    from fluxvla.models.third_party_models.cosmos3.model.attention.flash3.stubs import flash3_attention
