...
if NATTEN_SUPPORTED:
    from fluxvla.models.third_party_models.cosmos3.model.attention.natten.functions import (
        natten_attention,
    ...
    from fluxvla.models.third_party_models.cosmos3.model.attention.natten.stubs import (
        natten_attention,
        natten_multi_dim_attention,
        natten_multi_dim_attention_varlen,
    )
