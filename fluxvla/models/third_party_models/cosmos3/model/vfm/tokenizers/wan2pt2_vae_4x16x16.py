...
from fluxvla.models.third_party_models.cosmos3.utils.flags import DEVICE, INTERNAL, TRAINING
from fluxvla.models.third_party_models.cosmos3.utils import log
from fluxvla.models.third_party_models.cosmos3.utils.distributed import get_rank, sync_model_states
from fluxvla.models.third_party_models.cosmos3.utils.easy_io import easy_io
from fluxvla.models.third_party_models.cosmos3.data.vfm.utils import VIDEO_RES_SIZE_INFO
from fluxvla.models.third_party_models.cosmos3.model.vfm.tokenizers.interface import VideoTokenizerInterface
from fluxvla.models.third_party_models.cosmos3.utils.vfm.data_utils import get_vision_data_resolution
...
def _video_vae(
    ...
    if pretrained_path is None:
        ...
        if get_rank() == 0:
            if not INTERNAL:
                from fluxvla.models.third_party_models.cosmos3.utils.checkpoint_db import download_checkpoint_v2
