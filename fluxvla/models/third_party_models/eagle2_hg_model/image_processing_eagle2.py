...
from transformers.image_transforms import (PaddingMode, convert_to_rgb, pad,
...
from transformers.image_utils import (
    ...
    infer_channel_dimension_format, is_scaled_image, make_flat_list_of_images,
...
class Eagle2ImageProcessor(BaseImageProcessor):
    ...
    def _resize_for_patching(
        ...
        new_height, new_width = _get_patch_output_size(image,
                                                       target_resolution,
                                                       input_data_format)
        # Resize the image
    ...
    def get_image_patches(
        ...
        if self.pad_during_tiling:
            ...
            padded_image = self._pad_for_patching(
                resized_image, (target_height, target_width),
                input_data_format=input_data_format)
