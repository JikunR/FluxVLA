...
class Eagle2_5_VLConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if vision_config is None:
            ...
            logger.info(
                'vision_config is None. Initializing the InternVisionConfig with default values.'  # noqa: E501
            )

        if text_config is None:
            text_config = {'architectures': ['Qwen2ForCausalLM']}
            logger.info(
                'text_config is None. Initializing the LlamaConfig config with default values (`LlamaConfig`).'  # noqa: E501
            )
        ...
        if vision_config['model_type'] == 'siglip_vision_model':
            ...
            raise ValueError('Unsupported model_type: {}'.format(
    ...
    def to_dict(self):
        ...
        output[
            '_attn_implementation_autoset'] = self._attn_implementation_autoset
