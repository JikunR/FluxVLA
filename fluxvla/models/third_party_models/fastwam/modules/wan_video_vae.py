...
class _CachedResampleBase(nn.Module):
    """Shared cached resampling forward pass for the Wan2.2 VAE."""
...
class Resample38(_CachedResampleBase):
...
class _VAECacheBase(nn.Module):
    """Cache management shared by the Wan2.2 VAE encoder and decoder."""
...
class _WanVideoVAEBase(nn.Module):
    """Inference API shared by the Wan2.2 VAE wrapper."""
...
class VideoVAE38_(_VAECacheBase):
...
class WanVideoVAE38(_WanVideoVAEBase):
