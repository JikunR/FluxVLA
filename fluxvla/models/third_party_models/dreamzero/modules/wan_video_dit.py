...
#
# Origin: Source
# Upstream-URL: https://github.com/dreamzero0/dreamzero/blob/main/groot/vla/model/dreamzero/modules/wan_video_dit.py
# Upstream-Ref: main
...
if ENABLE_TENSORRT:
    ...
    DISABLE_TORCH_COMPILE = True  # Disabled due to triton 3.6 compatibility
...
def sinusoidal_embedding_1d(dim, position):
    sinusoid = torch.outer(
        ...
        torch.pow(
            10000, -torch.arange(
                dim // 2, dtype=torch.float64, device=position.device).div(
                    dim // 2)))
...
class RotaryPositionEmbeddingNoPolarOp(nn.Module):
    ...
    def precompute_freqs_cis_3d(self,
                                dim: int,
                                end: int = 1024,
                                theta: float = 10000.0):
        # 3d rope precompute
        f_freqs_cis = self.precompute_freqs_cis(dim - 2 * (dim // 3), end,
                                                theta)
    ...
    def post_initialize(self):
        self.freqs = {
            key: (value[0].to('cuda'), value[1].to('cuda'))
...
class AttentionModule(nn.Module):
    ...
    def forward(self, q, k, v):
        x = flash_attention(
            ...
            compatibility_mode=FLASH_ATTN_COMPATIBILITY_MODE)
        return x
...
class DiTBlock(nn.Module):
    ...
    def forward(self, x, context, t_mod, freqs):
        ...
        shift_msa, scale_msa, gate_msa, shift_mlp, scale_mlp, gate_mlp = (
            ...
            t_mod).chunk(
                6, dim=1)
        input_x = modulate(self.norm1(x), shift_msa,
                           scale_msa).to(dtype=t_mod.dtype)
        x = self.gate(x, gate_msa, self.self_attn(input_x, freqs))
        x = x + self.cross_attn(
            self.norm3(x).to(dtype=t_mod.dtype), context.to(dtype=t_mod.dtype))
...
class Head(nn.Module):
    ...
    def forward(self, x, t_mod):
        ...
        shift, scale = (self.modulation.repeat(batch_size, 1, 1).to(
            dtype=t_mod.dtype, device=t_mod.device) +
                        t_mod.unsqueeze(1)).chunk(
                            2, dim=1)
...
class WanModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        if has_image_input:
            self.img_emb = MLP(
                1280, dim,
                has_pos_emb=has_image_pos_emb)  # clip_feature_dim = 1280
        if has_ref_conv:
...
class WanModelStateDictConverter:
    ...
    def from_civitai(self, state_dict):
        ...
        if hash_state_dict_keys(
        ...
        elif hash_state_dict_keys(
                state_dict) == 'aafcfd9672c3a2456dc46e1cb6e52c70':
            config = {
                'has_image_input': False,
                'patch_size': [1, 2, 2],
                'in_dim': 16,
                ...
                state_dict) == '6bfcfb3b342cb286ce886889d519a77e':
            config = {
                ...
                state_dict) == '6d6ccde6845b95ad9114ab993d917893':
            config = {
                'has_image_input': True,
                'patch_size': [1, 2, 2],
                'in_dim': 36,
            ...
            config = {
                ...
                state_dict) == '349723183fc063b2bfc10bb2835cf677':
            # 1.3B PAI control
            config = {
                'has_image_input': True,
                'patch_size': [1, 2, 2],
                ...
                state_dict) == 'efa44cddf936c70abd0ea28b6cbe946c':
            # 14B PAI control
            config = {
                'has_image_input': True,
                'patch_size': [1, 2, 2],
                ...
                state_dict) == '3ef3b1f8e1dab83d5b71fd7b617f859f':
            config = {
                'has_image_input': True,
                'patch_size': [1, 2, 2],
                'in_dim': 36,
                ...
                state_dict) == '70ddad9d3a133785da5ea371aae09504':
            ...
            config = {
                ...
                state_dict) == '26bde73488a92e64cc20b0a7485b9e5b':
            ...
            config = {
                ...
                state_dict) == 'ac6a5aa74f4a0aab6f64eb9a72f19901':
            ...
            config = {
                ...
                state_dict) == 'b61c605c2adbd23124d152ed28e049ae':
