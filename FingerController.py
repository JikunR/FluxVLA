...
class FingerController:
    ...
    def __init__(self):
        ...
        self.finger_cmd_publisher = mros.advertise(
            '/brainco1/hand/cmd', mros.std_msgs.msg.Float32Array)
    ...
    def run(self):
        ...
        try:
            while True:
                cmd = [0, 0, 100, 100, 0, 0, 0, 0, 0, 0, 0, 0]  # 示例命令
                self.publish_cmd(cmd)
                time.sleep(1)

                # Example alternating command:
                # cmd = [100, 0, 100, 0, 100, 0, 100, 0, 100, 0, 100, 0]
                # self.publish_cmd(cmd)
                # time.sleep(0.5)
