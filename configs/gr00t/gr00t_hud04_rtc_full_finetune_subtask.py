...
inference = dict(
    ...
    task_descriptions={
        ...
        '2': 'lift up the red basket with right arm ',
        '3': 'put the green tissue in the red basket with left arm ',
        '4': 'put the green snack in the red basket with left arm ',
        '5': 'put the blue and white plush toy in the red basket with left arm ',
        '6': 'put the red bottle in the red basket with left arm ',
        '7': 'put the white cylindrical with black stripes in the red basket with left arm ',
        '8': 'put the small blue bottle in the red basket with left arm ',
        '9': 'put the small blue tissue pack in the red basket with left arm ',
        '10': 'place the red basket on the table',
        '11': 'put the blue can in the red basket with left arm ',
        '12': 'put the yellow snack in the red basket with left arm ',
        '13': 'put the green toy in the red basket with left arm ',
        '14': 'put the beige toy in the red basket with left arm ',
        '15': 'put the blue water bottle in the red basket with left arm ',
    },
    mixed_precision_dtype='bf16',
    dataset=dict(
