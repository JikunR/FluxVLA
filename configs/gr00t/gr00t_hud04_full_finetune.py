...
inference = dict(
    ...
    task_descriptions={
        ...
        '2':
        'Grasp the cup and pour the candies onto the table with the right arm, hang the mug on the mug rack with the right arm, and classify all candies on the table into the snack tray with the left arm.',  # noqa: E501
    },
    mixed_precision_dtype='bf16',
    dataset=dict(
    ...
    denormalize_action=dict(
        type='DenormalizePrivateAction', norm_type='min_max', action_dim=52),
    operator=dict(
