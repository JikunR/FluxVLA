...
#
# FastWAM per-rank random-mode forward / IDM / policy model on LIBERO-10.
...
model = dict(
    ...
    vla_head=dict(
        type='FastWAMPolicyForwardIDMHead',
        ...
        mode_probs=dict(forward=1.0, idm=1.0, policy=1.0),
        broadcast_training_mode=False,
    ),
)
