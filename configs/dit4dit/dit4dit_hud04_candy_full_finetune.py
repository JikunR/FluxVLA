"""DiT4DiT training and Oli inference for the HUD04 candy tasks."""
...
_root = ('/mnt/data/cpfs/limx_embmc/VLA_Data/Fixed-Feet-Mani/hf_cache/'
         'lerobot/lerobot')
_data_roots = [
    f'{_root}/{name}' for name in [
...
_action_dim, _output_action_dim, _state_dim = 64, 52, 64
