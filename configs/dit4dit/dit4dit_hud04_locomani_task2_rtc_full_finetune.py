"""DiT4DiT training-time RTC and Oli RTC inference for Loco-Mani task 2."""
...
_task = ('Turn right and walk to the table. Pick up the basket from the floor '
         'with the right hand. Pick up the plush toys on the table with the '
         'left hand, one by one, and place them into the basket. After all '
         'plush toys are in the basket, place the basket on the floor.')
