...
#
# WAM on HUD04 / VCube Candy data with FDM, IDM, and policy objectives.
# IDM and policy predict action directly instead of predicting a concatenated
# state-action chunk through WAMStateChunkHead.
#
...
#       tray with left arm
#
# Raw state/action dims are 43/52 and are padded to 64. Precompute the Wan/T5
# text embedding cache first:
