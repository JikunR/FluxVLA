...
#
# WAM on HUD04 Loco-Mani plush-to-chair and box-stacking tasks with FDM,
# IDM, and policy objectives. IDM and policy predict controller actions
# directly through WAMHead.
