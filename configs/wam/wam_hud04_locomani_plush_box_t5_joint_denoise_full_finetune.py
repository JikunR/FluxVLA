...
#
# WAM on HUD04 Loco-Mani plush-to-chair and box-stacking tasks with action and
# pixel prediction. The video and action experts are both noised and denoised
# together in one bidirectional MoT pass via the ``joint`` mode.
