...
#
# WAM on HUD04 / VCube candy data with action and pixel prediction.
# The video and action experts are both noised and denoised together in one
# bidirectional MoT pass via the ``joint`` mode. The action expert predicts
# controller actions, while the video expert predicts future pixels.
#
