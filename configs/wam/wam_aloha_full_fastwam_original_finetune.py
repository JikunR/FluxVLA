...
#
# WAM on the ALOHA fold-cloth data, using the original FastWAM-style base
# objective: one MoT forward simultaneously trains video generation
# (VGM/forward_video) and policy action prediction.
