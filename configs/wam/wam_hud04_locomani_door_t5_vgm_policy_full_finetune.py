...
#
# WAM on the HUD04 Loco-Mani door-opening task with joint VGM and
# policy action prediction. The two datasets contain 166 episodes / 94,717
# frames. Raw state/action dimensions are 33/42; both are padded to 64.
#
