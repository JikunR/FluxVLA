...
- Supports trajectory postprocessing with reusable MPC and Ruckig backends; see [Trajectory Postprocessing](docs/trajectory_postprocessing.md) for configuration, stitching, and benchmark details.
